...
const DeleteRoomModal: React.FC<DeleteRoomModalProps> = ({
  ...
  const handleDelete = async () => {
    ...
    if (confirmationPrice !== room.price_per_night.toString()) {
      setError("Price confirmation does not match. Please enter the exact price per night.");
      return;
    }
        ...
        <div className="p-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{formatRoomType(room.room_type)}</span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span>{room.hotel.city.name}, {room.hotel.country.name}</span>
                </div>
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <span className="font-bold text-red-600">${room.price_per_night}</span>
            </label>
            <input
              type="number"
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-red-700">
                ...
                <ul className="mt-1 list-disc list-inside space-y-1">
                  <li>This will permanently delete the room and all its data</li>
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              disabled={loading || confirmationPrice !== room.price_per_night.toString()}
